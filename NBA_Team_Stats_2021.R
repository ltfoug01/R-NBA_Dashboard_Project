...
NBA_Team_Stats_2021 
  ...
  the 2021 per game stats of an NBA team of their choice as well as the game log.
  The function is called using the abbreviation of the team of choice as a 
  parameter.
...
NBA_Team_Stats_2021 <- function(team_abbreviations){
  ...
  df <- df[-c(22,23),]                  #remove extra rows
